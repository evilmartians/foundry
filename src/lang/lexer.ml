...
| '!'      -> expr_begin state true;  Tk_NOT     (locate state lexbuf, lexeme lexbuf)
| "&&"     -> expr_begin state true;  Tk_AND     (locate state lexbuf, lexeme lexbuf)
| "||"     -> expr_begin state true;  Tk_OR      (locate state lexbuf, lexeme lexbuf)
...
| "case"   -> expr_begin state true;  Kw_CASE    (locate state lexbuf, lexeme lexbuf)
| "when"   -> expr_begin state true;  Kw_WHEN    (locate state lexbuf, lexeme lexbuf)
