...
%token <Location.t * Unicode.utf8s> Tk_NE      "`!='"
%token <Location.t * Unicode.utf8s> Tk_LT      "`<'"
%token <Location.t * Unicode.utf8s> Tk_GT      "`>'"
%token <Location.t * Unicode.utf8s> Tk_LE      "`<='"
%token <Location.t * Unicode.utf8s> Tk_GE      "`>='"
...
%token <Location.t * Unicode.utf8s> Tk_AND     "`&&'"
%token <Location.t * Unicode.utf8s> Tk_OR      "`||'"
%token <Location.t * Unicode.utf8s> Tk_NOT     "`!'"
...
%token <Location.t * Unicode.utf8s> Kw_CASE    "case"
%token <Location.t * Unicode.utf8s> Kw_WHEN    "when"
