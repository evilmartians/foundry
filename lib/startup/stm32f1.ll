...
declare extern_weak void @_tim8_brk()
declare extern_weak void @_tim8_up()
declare extern_weak void @_tim8_trg_com()
...
@__vectors__ = appending global [60 x i32*] [
  ...
  i32* bitcast(void()* @_tim8_brk to i32*),
  i32* bitcast(void()* @_tim8_up to i32*),
  i32* bitcast(void()* @_tim8_trg_com to i32*),
